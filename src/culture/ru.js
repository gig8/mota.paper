(function (translator) {
	translator.translations["ru"] = {
		...
		"paperlabelmotacoinaddress": "Адрес MotaCoin кошелька:",
		...
		"generatelabelmotacoinaddress": "Генерация Биткоин адреса...",
		...
		"footerlabelsig": "sig",
		"footerlabelcopyright1": "Копирайт MotaCoin.",
		...
		"singlelabelmotacoinaddress": "Адрес Биткоин кошелька",
		...
		"brainlabelmotacoinaddress": "Адрес Биткоин кошелька:",
		...
		"vanitylabelmotacoinaddress": "Адрес Биткоин кошелька:",
		"vanitylabelnotesmotacoinaddress": "Это Ваш новый адрес с префиксом.",
		...
		"detaillabelnote2": "Приложение MotaCoin версии 0.6 и выше хранит ключи в сжатом формате. Это приложение также поддерживает импорт и экспорт приватных ключей командами importprivkey/dumpprivkey. Формат экспортированного ключа определяется кошельком, который сгенерировал адрес Биткоин.",
		"detaillabelmotacoinaddress": "Адрес Биткоин кошелька",
		"detaillabelmotacoinaddresscomp": "Короткий адрес Биткоин кошелька",
