ninja.seeder = {
	...
	seed: function (evt) {
		...
		if (ninja.seeder.seedCount == ninja.seeder.seedLimit) {
			...
			// seed mouse position X and Y when mouse movements are greater than 10ms apart.
		else if ((ninja.seeder.seedCount < ninja.seeder.seedLimit) && evt && (timeStamp - ninja.seeder.lastInputTime) > 10) {
